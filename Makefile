...
###############################################################################
GCC_BIN = /Users/mohesk/opt/gcc-arm-none-eabi-6-2017-q1-update/bin/
PROJECT = lpc1768_lwm2m
OBJECTS = $(APP_OBJ) $(SWUPDATE_OBJ) $(WAKAAMA_OBJ) $(ETHERNET_OBJ) $(RTOS_OBJ) 
...
INCLUDE_PATHS = $(SWUPDATE_INC) $(WAKAAMA_INC) $(ETHERNET_INC) $(RTOS_INC) -I. -I./mbed -I./mbed/TARGET_LPC1768 -I./mbed/TARGET_LPC1768/TOOLCHAIN_GCC_ARM -I./mbed/TARGET_LPC1768/TARGET_NXP -I./mbed/TARGET_LPC1768/TARGET_NXP/TARGET_LPC176X -I./mbed/TARGET_LPC1768/TARGET_NXP/TARGET_LPC176X/TARGET_MBED_LPC1768 
